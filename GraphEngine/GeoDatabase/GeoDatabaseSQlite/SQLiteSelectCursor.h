...
namespace GraphEngine {
    namespace GeoDatabase {
        ...
        public:
            ...
            CSQLiteSelectCursor(const std::string& sTableName, const std::string& sOIDName, const std::string& sSpatialIndex, const std::string& sShapeFieldName, IFieldsPtr  ptrSourceFields, IQueryFilterPtr ptrFilter, Geometry::ISpatialReferencePtr ptrSpatRefSource, CommonLib::database::IDatabasePtr ptrDatabase);
