...
#pragma warning(pop)
   ...
   // const int sub_scale_pix = 8; //10
   // const int pix_step = 1 << sub_scale_pix;
    const int half_pix_step = poly_subpixel_scale >> 1;
    const int square_pix_step = poly_subpixel_scale * poly_subpixel_scale;
