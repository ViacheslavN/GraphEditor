...
namespace GraphEngine {
    namespace Display {
        ...
        public:
            ...
            void SetOffset(GUnits offsetX, GUnits offsetY);
            void GetOffset(GUnits* offsetX, GUnits* offsetY);
        private:
            ...
            unsigned vertex(double *x, double *y)
            {
                ...
                while(true)
                {
                    ...
                    if(m_vecPoints.size() > 1)
                    {
                        ...
                        CConvOffset::Gen(m_nOffset, &points, &pointCount, 1);
                        if(points)
                        {
