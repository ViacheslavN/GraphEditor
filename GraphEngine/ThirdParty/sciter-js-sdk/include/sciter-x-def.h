 ...
 **/
 ...
 typedef void SciterRunCallback(LPVOID RunCallbackTag);
 ...
 typedef enum SCITER_APP_CMD {
   ...
   SCITER_APP_RUN_PULSE_CALLBACK = 5, /// p1 - SciterRunCallback*, p2 - LPVOID RunCallbackTag, the callback is called in GUI thread regularly before processing a message in GUI event queue.
 } SCITER_APP_CMD;
